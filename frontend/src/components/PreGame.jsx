  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen bg-gray-900 ">
      ...
      <div className="absolute flex w-full justify-center top-12 px-36">
        <h1 className="text-gray-300 w-fit max-w-12 border border-gray-300 text-center px-28 py-1">
              ...
              <div className="flex">
                <div className="flex flex-col py-5">
                  <div className="relative flex items-center w-48">
                    ...
                    />
                    <span className="px-3 py-3 text-gray-300 text-base w-fit max-w-12 font-medium truncate ">
                      {data[0]?.name}{" "}
                    </span>
                ...
                <div className="relative flex justify-center items-center w-48">
                  <div className="flex-grow border-t border-gray-500"></div>
                  {/* <span className="px-3 text-gray-300 text-base w-fit max-w-12 font-medium truncate">
                    team 1/2
                  </span> */}
                  <span className="px-3 text-gray-300 text-base w-fit max-w-12 font-medium truncate">
                    -----------
